...
module Actions
  module Fusor
    module Deployment
      module OpenShift
        class InstallImage < Actions::Fusor::FusorBaseAction
          def humanized_name
            _("yum install the RHEL 7.2 image rpm for OSE VMs")
          end
          ...
          def run
            ::Fusor.log.debug "================ InstallImage run method ===================="
            begin
              ...
              fail _("Failed to install the RHEL 7.2 image rpm for OSE VMs. Error message: #{e.message}")
            end
            ::Fusor.log.debug "================ Leaving InstallImage run method ===================="
          end
